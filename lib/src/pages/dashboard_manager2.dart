...
import 'package:task_manager/src/pages/add_programmer_task.dart';
import 'package:task_manager/src/pages/list_task_manager2.dart';
import 'package:task_manager/src/providers/auth.dart';
import 'package:task_manager/src/providers/navigator_index.dart';

class DashBoardPageManager2 extends StatefulWidget {
  const DashBoardPageManager2({Key? key}) : super(key: key);

  @override
  _DashBoardPageManager2State createState() => _DashBoardPageManager2State();
}

class _DashBoardPageManager2State extends State<DashBoardPageManager2> {
  final List<String> titles = [
    AppStrings.titleHome,
    AppStrings.titleAddProgrammers,
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          ...
          BottomNavigationBarItem(
            ...
            label: AppStrings.titleAddProgrammers,
          ),
          BottomNavigationBarItem(
            icon: Icon(
